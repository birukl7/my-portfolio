  ...
  return (
    <footer className='py-3 mt- flex sm:flex-row flex-col items-center justify-center gap-x-7 dark:text-black pt-16'>
      <div className='flex flex-col items-center'>
        <div className=' text-[17px] pb-2 sm:pb-0  font-Outfit'>Build by Biruk with ❤️</div>
      ...
      <Technology text = {'Updated: April 20 2024'} class={'sm:p-3 font-Outfit rounded-none  bg-white text-black sm:uppercase p-3'} />
