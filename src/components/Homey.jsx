...
function Homey() {
  ...
  return (
    <div className='bg-slate-950 dark:bg-slate-200'>
      <header className='text-md font-semibold p-2 fixed w-full bg-slate-950 dark:bg-slate-200 max-w-screen-xl my-0 mx-auto right-0 left-0'>
        <div className='flex justify-between items-center'>
          ...
          <div className='w-9 h-1 bg-slate-100 dark:bg-slate-900 rounded-full relative after:bg-slate-100 after:dark:bg-slate-900 after:block after:w-full after:absolute after:top-2 after:h-1 after:rounded-full 
           before:bg-slate-100 before:dark:bg-slate-900 before:block before:w-full before:absolute before:bottom-2 before:h-1 before:rounded-full cursor-pointer before:transition-all  before:ease-in-out before:duration-200 after:transition-all after:ease-in-out after:duration-200 ' onClick={toggleMobileNav} id='hamburger'/>
        </div>
        <nav className='fixed top-0 bottom-0 transition ease-in-out duration-300 overflow-hidden left-0 bg-slate-700 dark:bg-slate-300  flex flex-col justify-between items-center w-0' id='nav-bar'>
